    ...
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img 
          ...
          alt="REN Health Wellness Background - Premium Confinement Care"
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <div className="flex items-center gap-2 bg-ren-gold/5 px-3 py-1 rounded-full border border-ren-gold/10">
                <img 
                  ...
                  alt="Motherhood Choice Award Logo"
                  referrerPolicy="no-referrer"
                />
                <span className="text-[9px] font-bold text-ren-gold uppercase tracking-widest">{t.award}</span>
              </div>
            </div>
            <h2 className="text-7xl md:text-9xl font-serif leading-[0.85] mb-10 text-ren-ink">
              {t.title1} <br />
            ...
            >
              <div className="aspect-square rounded-[40px] overflow-hidden mb-8 relative shadow-sm group-hover:shadow-2xl transition-all duration-700">
                <img 
                  ...
                  alt={`${t.items[idx].name} - Premium Herbal Tea`} 
                  referrerPolicy="no-referrer"
                />
                <div className="absolute inset-0 bg-ren-ink/5 group-hover:bg-transparent transition-colors" />
              </div>
              ...
              <div className="relative flex-1">
                ...
                >
                  <img 
                    src="/OurStory.jpg" 
                    className="w-full h-full object-cover"
                    alt="REN Health Heritage and Story - Traditional Herbal Wisdom for Modern Women"
                    referrerPolicy="no-referrer"
                  />
                </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-24">
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex space-x-6">
              <div 
                className="w-10 h-10 rounded-full border border-ren-gold/20 flex items-center justify-center text-ren-gold hover:bg-ren-gold hover:text-white transition-all cursor-pointer"
...
export default function App() {
  ...
  return (
    <div className="min-h-screen selection:bg-ren-gold/20">
      ...
      <main>
        <h1 className="sr-only">REN Health - Premium Female Wellness & Confinement Care in Malaysia</h1>
